            ...
            <div className="maininfo__container-change-now">
                ...
                <div className="maininfo__telf-and-btn">
                    ...
                    <div className="maininfo__terminos">
                        <input type="checkbox" id="cbox2" value="maininfo__terminos" /> <label htmlFor="cbox2">    Acepto <u>términos y condiciones</u> y autorizo el tratamiento de datos personales </label>
                    </div>
                    
                </div>
            </div>
            <a id="maininfo__star-link" href="https://www.grupodot.com/es/" target="_blank" rel="noreferrer">
                <img 
